...
import com.example.pye.Adapter.MyCommentAdapter;
import com.example.pye.Callback.ICommentCallbackListener;
...
public class CommentFragment extends BottomSheetDialogFragment implements ICommentCallbackListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        commentViewModel.getMutableLiveDataServiceProviderList().observe(this, commentModels -> {
